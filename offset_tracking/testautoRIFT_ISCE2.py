...
def main():
    ...
    generateAutoriftProduct(slc_imgs=inps.slc_imgs, grid_location=inps.grid_location,
...
def generateAutoriftProduct(slc_imgs, grid_location, search_range, chip_size_min, chip_size_max,
    ...
    if optical_flag == 1:
        ...
        for i in range(len(slc_imgs)):
            data_all.append(loadProduct(slc_imgs[i]))
