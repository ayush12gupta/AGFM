    ...
    for swath in swathList:
        ...
        if numCommon > 0:
            ...
            for index in range(numCommon):
                ...
                hgtname = os.path.join(dirname, 'hgt_dem_%02d.rdr'%(ind+1))
                losname = os.path.join(dirname, 'los_dem_%02d.rdr'%(ind+1))
                incidname = os.path.join(dirname, 'incid_%02d.rdr'%(ind+1))
