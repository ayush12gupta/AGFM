...
DEMZ_FILENAME = Application.Parameter(
     'demzeroFilename',
     public_name='demzeroFilename',
     default='demLat_zero.dem',
     type=str,
     mandatory=False,
...
_INSAR = Application.Facility(
    ...
    args = ('topsAppContext',isceobj.createCatalog('DemProc')),
    mandatory=False,
    doc="DemProc object"
)
...
class DemInSAR(Application):
    ...
    def __init__(self, family='', name='',cmdline=None):
        import isceobj
        from isceobj.DemProc import DemProc
    ...
    def Usage(self):
        print("Usages: ")
        print("DemApp.py <input-file.xml>")
        print("DemApp.py --steps")
        print("DemApp.py --help")
        print("DemApp.py --help --steps")
    ...
    def _add_methods(self):
        self.runPreprocessor = DemProc.createPreprocessor(self)
        self.runComputeBaseline = DemProc.createComputeBaseline(self)
        self.verifyDEM = DemProc.createVerifyDEM(self)
        self.verifyGeocodeDEM = DemProc.createVerifyGeocodeDEM(self)
        self.runTopo  = DemProc.createTopo(self)
        self.runTopoZero  = DemProc.createTopoZero(self)
        self.runSubsetOverlaps = DemProc.createSubsetOverlaps(self)
        self.runCoarseOffsets = DemProc.createCoarseOffsets(self)
        self.runCoarseResamp = DemProc.createCoarseResamp(self)
        self.runOverlapIfg = DemProc.createOverlapIfg(self)
        self.runPrepESD = DemProc.createPrepESD(self)
        self.runESD = DemProc.createESD(self)
        self.runRangeCoreg = DemProc.createRangeCoreg(self)
        self.runFineOffsets = DemProc.createFineOffsets(self)
        self.runFineResamp = DemProc.createFineResamp(self)
        self.runIon = DemProc.createIon(self)
        self.runBurstIfg = DemProc.createBurstIfg(self)
        self.runMergeBursts = DemProc.createMergeBursts(self)
        self.runFilter = DemProc.createFilter(self)
    ...
    def _steps(self):
        ...
        ##Run topoZero for each bursts
        self.step('topozero', func=self.runTopoZero)
        ...
        # Compute DEM
        self.step('computedem', func=self.runComputeDem)
